...
import ListaMaterias from "./ListaMaterias.json"; 
...
//                       }]
const Lista = ListaMaterias.asignaturas;
...
const SeccionHorarioAsignaturas = (props) => {
    ...
    return ( 
        <div className="contenedor-seccion">
            ...
            <ContenedorAsignaturas ListaMaterias={Lista} agregarAsignatura={agregarAsignatura} desagregarAsignatura={desagregarAsignatura} />
        </div>
     );
}
