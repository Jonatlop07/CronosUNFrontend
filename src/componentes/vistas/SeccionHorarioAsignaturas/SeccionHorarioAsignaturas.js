...
const SeccionHorarioAsignaturas = (props) => {
    ...
    return ( 
        <div className="contenedor-seccion">
            ...
            <ContenedorHorario horarioActualizado={horarioActualizado} setHorarioEnvio={setHorarioEnvio} materiasEliminadas={materiasEliminadas} />
            <input type="submit" value="Guardar Horario" className="contenedor-seccion-boton-agregar" onClick={routeChange}/>
